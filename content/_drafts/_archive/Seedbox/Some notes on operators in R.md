...
You can illustrate logical AND (&) and OR (|) by comparing numerical values. Create a variable _x_ that is equal to 10. 
...
Check out the article about [R Operators](https://r-coder.com/operators-r/#Assignment_operators_in_R "This link takes you to the Assignment Operators in R section of the R Operators guide from R Coder.") on the R Coder website for a comprehensive guide to the different types of operators in R. The article includes lots of useful coding examples, and information about miscellaneous operators, the infix operator, and the pipe operator.