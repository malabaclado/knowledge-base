...
alias: [Model selection for support vector machine classification]
---
# Model selection for support vector machine classification

> [!info]
> - **Cite Key:** [[@goldModelSelectionSupport2003]]
...
> - **Bibliography:** Gold, C., & Sollich, P. (2003). Model selection for support vector machine classification. _Neurocomputing_, _55_(1), 221–249. [https://doi.org/10.1016/S0925-2312(03)00375-8](https://doi.org/10.1016/S0925-2312(03)00375-8)
> - **Tags:** #Classification, #Support-vector-machines, #Model-selection, #Bayesian-evidence, #Probabilistic-methods
...
%% Import Date: 2023-02-27T20:33:43.407+08:00 %%
