...
- **PostgreSQL** - A popular open-source database with a very complete library of analytical functions. This is the database used in the course.

# Why is SQL important?
1.	Easy to understand
2.	Can access data directly (from databases)
3.	Can audit data
...
---
[[Flashcards (Intro to SQL - Udacity Challenge)]]